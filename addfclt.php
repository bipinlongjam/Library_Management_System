...
if(isset($_POST["import"]))
{
 ...
 if(in_array($extension, $allowed_extension)) //check selected file extension is present in allowed extension array
 {
  ...
  foreach ($objPHPExcel->getWorksheetIterator() as $worksheet)
  {
   ...
   {
    $output .= "<tr>";
    $fcltid = mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(0, $row)->getValue());
    ...
    $mno = mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(5, $row)->getValue());

    $query =  "INSERT INTO fclt (flctid, name, fname, dept, dob, mno) VALUES ('".$fcltid."', '".$name."', '".$fname."', '".$dept."', '".$dob."', '".$mno."')";
...
<html>
 ...
 <body>
    ...
    <p class="text-center" style="color: white;">(For Faculty)</p><br>
   <div class="container">
        <div class="row">
