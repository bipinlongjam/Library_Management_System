...
<head>
    ...
    <title>Delete Faculty - Library Management</title>
...
?>
    ...
    <h2 class="h2 text-center">Enter the Faculty's details to delete</h2><br><hr>
    ...
    if(isset($_POST['delete']))
        {
            ...
            $query= "DELETE FROM fclt WHERE fcltid = '$fcltid'";
   
            $r = mysqli_query($conn,$query);

            if ($r ==  true) {
                echo "<script>alert('Faculty's Details Deleted Successfully');</script>";
            }
            else{
