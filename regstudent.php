...
<head>
    ...
    <title>Register Student - Library Management</title>
...
<h2 class="h2 text-center">Enter the Student's details to register</h2> <hr>
    ...
    if(isset($_POST['register']))
        {
            ...
            $query= "INSERT INTO std (roll_no, name, fname, branch, year, dob, mno) 
                VALUES ('$roll_no', '$name', '$fname', '$branch', '$year', '$dob', '$mno')";
